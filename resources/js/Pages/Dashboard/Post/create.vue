...
<template>
    <DashboardLayout>
        ...
        <h5 class="pt-5 pb-2"><i class="bi bi-pin-angle"></i> Create new post</h5>
                    ...
                    <div class="col-4">
                        ...
                        <div class="row mb-3 bg-white p-2 border">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <PrimaryButton :processing="form.processing" class="mt-2">Create</PrimaryButton>
                            </div>                           
                        </div>    
                        ...
                        <div class="row mb-3 bg-white p-2 border">
                            <div class="col">
                                ...
                                <CheckboxGroup id="categories" v-model="form.categories" :fields="categories" />                        
